            ...
            <fieldset style="height:270px">
                <fieldset>
                    ...
                    <form method="POST">
                        ...
                        Date of Birth: <input type="text" name="dd" value="" width=100>/&nbsp <input type="text"
                            name="mm" width=100>/&nbsp <input type="text" name="yy" width=100> (dd/mm/yyyy)
                </fieldset>
                ...
                Gender: <input type="radio" name="gender" value="male" id="male"
                    <?php if($_SESSION['gender']=='Male') echo "checked";?>>Male
                <input type="radio" name="gender" value="female" id="female"
                    <?php if($_SESSION['gender']=='female') echo "checked";?>>Female
                <input type="radio" name="gender" value="other" id="other"
                    <?php if($_SESSION['gender']=='other') echo "checked";?>>Other
                <br>
